package net.galacticprojects.spigot.command.message;
import java.util.Arrays;
import java.util.stream.Collectors;

import me.lauriichan.laylib.localization.source.IMessageDefinition;

public enum CommandManagerMessages implements IMessageDefinition {
    ...
    INPUT_FAILED(new String[] {
            "$#plugin.prefix Failed to parse your input of type !",
    ...
    private CommandManagerMessages() {
        this("");
    }

    private CommandManagerMessages(String[] fallback) {
